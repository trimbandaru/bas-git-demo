		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Orders",
									"targetURL": "#comdemodemoapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemodemoapp-display": {
								"semanticObject": "comdemodemoapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.demoapp",
									"url": sap.ui.require.toUrl("com/demo/demoapp")
								}
							}
						}
					}
